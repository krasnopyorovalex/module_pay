...
new Vue({
    ...
    methods: {
        ...
        if(this.name && this.email && this.phone){
          ...
          jQuery.ajax({
              ...
              success: function(data){
                  yaCounter17190040.reachGoal('COST');
      ...
      showOrder: function(room){
        return this.checkedRoom = room;
      },
      hideOrder: function(){
        return this.checkedRoom = null;
      },
      getAllRooms: function() {
        if(jQuery('#arrival-date').val() && jQuery('#departure-date').val()){
          this.loading = true
          this.$http.get(this.endpoint + '?' + jQuery('#calculate-form').serialize()).then(function(response){
    ...
    directives: {
        phone:{
          bind: function(){
            jQuery(this.el).inputmask('+7 999 999 99 99');
          }
        },
        owl:{
            bind: function () {
